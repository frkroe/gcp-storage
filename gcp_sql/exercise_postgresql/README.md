...
You might be asked to create another free account for Tonic Fabricate, with which we build our fake database.

By using their agentic AI, let's create the database with our tables and ask for 100 rows for each table with random, but realistic data.
