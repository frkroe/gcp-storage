...
In this exercise, we will create a simple model in BigTable to simulate a few stocks and their prices. We will use the `google-cloud-bigtable` library to interact with the BigTable instance.
...
```bash
nohup ./stock_prices.sh > stock_prices.log 2>&1 &
```
