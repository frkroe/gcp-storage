...
This exercise is to demonstrate the use of Google Cloud BigTable to store IoT data.

There are 3 folders in this exercise:

1. `raspberry_pico`: This folder contains the code to run on the Raspberry Pi Pico to simulate the IoT device. It reads the temperature from its internal sensor and it turns on and off the LED.
...
If you are using Windows, you can activate the virtual environment with the following command:
